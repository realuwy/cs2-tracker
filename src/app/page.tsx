  ...
  return (
    <main className="min-h-[calc(100vh-64px)] bg-[radial-gradient(60%_80%_at_50%_-10%,#171a22_0%,transparent_60%),linear-gradient(#0b0b0f,#0b0b0f)] text-white">
      ...
      <section className="mx-auto max-w-5xl px-6 pt-20 pb-10 text-center">
        <div className="inline-flex items-center gap-2 rounded-full bg-[#0b0b0f]/70 px-3 py-1 text-xs text-slate-300 ring-1 ring-slate-800/60">
        ...
        {/* Mock preview frame */}
        <div className="mx-auto mt-12 w-full max-w-5xl rounded-2xl border border-slate-800/60 bg-[#0b0b0f]/60 p-2 shadow-2xl">
          <div className="h-72 w-full rounded-xl bg-[linear-gradient(180deg,#0f1014,#0b0b0f)] ring-1 ring-slate-800/60" />
        </div>
      </section>
      ...
      <section className="mx-auto grid max-w-5xl grid-cols-1 gap-4 px-6 pb-20 sm:grid-cols-3">
        {/* Card 1 */}
        <div className="rounded-xl border border-slate-800/60 bg-[#0b0b0f]/70 p-5 text-center shadow-[0_0_30px_-20px_rgba(124,58,237,0.35)]">
