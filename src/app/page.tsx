...
export default function HomePage() {
  const openOnboarding = () => {
    if (typeof window !== "undefined") {
      window.dispatchEvent(new Event("onboard:open"));
    }
  };
          ...
          <div className="grid items-center gap-10 md:grid-cols-2">
            <div>
              ...
              <p className="mt-4 max-w-prose text-muted md:text-lg">
                Import manually, get live price snapshots, and keep everything local with a portable ID.
              </p>

              <div className="mt-8 flex flex-wrap items-center gap-3">
                <button onClick={openOnboarding} className="btn-accent">
                  Get Started
                </button>
              </div>

              <p className="mt-3 text-xs text-muted">
                No account required. Your unique ID keeps your dashboard portable across devices.
              </p>
            </div>
